...
interface AIInterface {
    void kataPembuka();
    static void kataPenutup() { 
        System.out.println("Selamat tinggal dari AI!"); // Penerapan interface 
    }
}

abstract class LayananAI {
    private String namaAnggota;
    private int umur;
    protected String pekerjaan;
    String tujuanKepentingan;
    public String namaAI;
    private String jenisAI;
    ...
    // Abstract method
    public abstract String getJenisAnggotaAI();
}
...
class DatabaseLayananAI {
    ...
    public ArrayList<LayananAI> getLayananList() {
        return layananList;
    }
}
...
final class GerryAICommunity implements AIInterface {
    private final ArrayList<LayananAI> layananList = new ArrayList<>();
    private final Scanner scanner = new Scanner(System.in);

    @Override
    public void kataPembuka() {
    ...
    public void menuTambah() {
        ...
        System.out.println("==============================================");
        LayananAI layanan = createAICommunityMember();

        layananList.add(layanan);
        System.out.println("\nData Pengguna Layanan AI berhasil ditambahkan!");
    }

    private LayananAI createAICommunityMember() {
    ...
    public static void main(String[] args) {
        GerryAICommunity gerryAICommunity = new GerryAICommunity();
        gerryAICommunity.run();

        AIInterface.kataPenutup(); // penerapan dari interface 
    }
}
